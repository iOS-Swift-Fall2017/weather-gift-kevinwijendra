        ...
        Alamofire.request(weatherURL).responseJSON { response in
            ...
            case .success(let value):
                ...
                for hour in 1...hours {
                    ...
                    let newHourlyForcast = HourlyForecast(hourlyTime: hourlyTime, hourlyTemperature: hourlyTemperature, hourlyPercipProb: hourlyPercipProb, hourlyIcon: hourlyIcon)
                    self.hourlyForecastArray.append(newHourlyForcast)
                }
